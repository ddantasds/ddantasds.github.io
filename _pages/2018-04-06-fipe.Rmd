...
```
```{r echo = FALSE}
fipe<-fipe[,fuel:=ifelse(combustivel=="Gasolina","Gasoline",
                                                                                                                                                  ifelse(combustivel=="Álcool","Alcohol",
                                                                                                                                                         ifelse(combustivel=="Diesel","Diesel",combustivel)))][,.("brand"=fipe_marca,"vehicle"=veiculo,"year_model"=ano_modelo,fuel,"price_reference"="June 2018",price)]

knitr::kable(head(fipe))
```
