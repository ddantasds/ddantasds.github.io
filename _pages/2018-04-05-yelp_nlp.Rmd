...
The dataset contains information to identify the review and also the number of stars given by the customer. We also have the review text.
...
Example of very short reviews. I belive we can still get good information from these.
