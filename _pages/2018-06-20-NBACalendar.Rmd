...
```{r, include=FALSE}
load("~/project/Data-Science-Projects/NBA calendar/list_distance.RData")
```
...
```{r, include=FALSE}
min_calendar<-read.csv("/home/ddantas/project/Data-Science-Projects/NBA calendar/output_calendar.csv")
```
